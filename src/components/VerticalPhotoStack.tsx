        ...
        <div className="relative w-full h-full max-w-[85vw] 2xl:max-w-[1600px] mx-auto">
          {photos.map((photo, index) => {
            ...
            if (isSliding) {
              ...
              const nextXPosition = nextPosition === 0 ? 0 : -14.6;
            ...
            return (
              <div
                ...
                className=""  
              >
                <div className="relative w-[55vw] max-w-[760px] aspect-[3/2] overflow-hidden rounded-2xl shadow-xl  border-white border-8">
                  <Image
                    src={photo.src}
