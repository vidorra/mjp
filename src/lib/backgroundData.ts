...
export const backgroundImages: BackgroundImage[] = [
  ...
  {
    id: 'eye-male',
    filename: 'eye-male.webp',
    prompt: 'Macro shot of a the eye of a Indonesian 72-year-old dark haired male with dark brown eyes , from front-view angle, taupe walls ultra sharp, captured with Canon EOS R5 using MP-E 65mm f/2.8 1-5x --style raw --v 6.1 --s 250 --ar 3:2 ',
    tags: {
      style: 'portrait',
      shotType: 'Macro',
      category: 'Person',
