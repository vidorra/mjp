...
<section className="px-12 py-16 flex">
  ...
  <div className="w-2/3">
    ...
    {/* Green floating card - you can adjust or remove this */}
    <div className="absolute -translate-y-52 -left-12 w-64 h-80 bg-background rounded-xl overflow-hidden shadow-lg p-6">
  ...
  <section className="px-12 py-16 bg-gradient-to-r from-primary to-orange-400 text-white container">
