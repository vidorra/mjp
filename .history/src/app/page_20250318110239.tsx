...
<section className="px-12 py-16 container mx-auto relative">
  <div className="flex">
    {/* Left side with text */}
    ...
    <div className="w-2/3 relative">
      {/* Floating card */}
      <div className="absolute top-1/2 -translate-y-1/2 -left-24 w-64 bg-background rounded-xl overflow-hidden shadow-lg p-6 z-10">
      ...
      {/* Image container */}
      <div className="bg-gray-900 rounded-2xl overflow-hidden ml-12">
