...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="min-h-[85vh] relative flex">
        {/* Left Content */}
        <div className="flex-0 flex flex-col justify-center pl-8 lg:pl-16">
        ...
        {/* Right Photo Stack */}
        <div className="flex-1 relative max-h-[85vh] overflow-hidden">
          <VerticalPhotoStack photos={photos} containerHeight={1000} />
        </div>
      </section>
