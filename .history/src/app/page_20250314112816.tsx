...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <div className="mx-auto my-8 max-w-7xl bg-white rounded-3xl shadow-sm overflow-hidden">
        
        {/* Header */}
        <header className="px-8 py-6 flex justify-between items-center">
          <div className="font-bold text-xl">Photography Prompt</div>
          <nav className="flex items-center space-x-8">
            <Link href="/" className="text-gray-600 hover:text-primary">Home</Link>
            <Link href="/tool" className="text-gray-600 hover:text-primary">Prompt Builder</Link>
            <Link href="/faqs" className="text-gray-600 hover:text-primary">FAQs</Link>
            <button className="bg-gray-900 text-white text-sm px-4 py-2 rounded-full">
              Sign up
            </button>
          </nav>
        </header>
        ...
        {/* Hero Section */}
        <section className="px-12 py-16 flex">
          <div className="w-1/2 pr-16">
            ...
            <p className="text-gray-600 mb-8 max-w-md">
              Dive into the ultimate photography experience with our intuitive tool.
              We specialize in creating vibrant, professional prompts.
            </p>
            ...
            <p className="text-xs text-gray-500 mt-4">Pick from various photography styles.</p>
          </div>
          ...
          <div className="w-1/2 relative">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative">
                ...
                <div className="rounded-3xl overflow-hidden shadow-lg absolute transform rotate-3 -left-12 -bottom-8">
                  <img 
                    src={photos[1].src} 
                    alt={photos[1].alt} 
        ...
        <section className="px-12 py-16 border-t border-gray-100">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-6">
              <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">Portrait</button>
              <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">Landscape</button>
              <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">Product</button>
              <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">Street</button>
              <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">Architecture</button>
            </div>
          </div>
          
          <div className="grid grid-cols-5 gap-6">
            {photos.map((photo) => (
              <div key={photo.id} className="rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
