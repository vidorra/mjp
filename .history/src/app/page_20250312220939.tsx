    ...
    <div className="min-h-screen relative">
      ...
      <section className="h-screen flex relative z-0">
        ...
        <div className="flex-1 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-white/80 via-white/20 to-transparent pointer-events-none z-10"></div>
      ...
      {/* Features Section */}
      <section className="py-24 bg-gray-50 relative z-50">
      ...
      <section className="py-24 bg-white relative z-50">
        <div className="container mx-auto px-4">
      ...
      <section className="py-24 bg-primary relative z-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            href="/tool"
            className="bg-white text-primary px-8 py-4 rounded-full text-lg font-semibold hover:bg-white/90 transition-colors inline-block"
          >
