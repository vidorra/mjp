...
<div className=" bg-white z-20 relative">
  {/* Categories Section */}
  <section className="w-full h-20 inline-block from-transparent to-white "></section>
...
<section className="px-12 py-16 flex container">
  {/* Left side with text */}
  ...
  <div className="w-2/3">
    <div className="bg-gray-900 rounded-2xl relative ">
      ...
      <div className="p-8 grid grid-cols-3 gap-6 justify-end">
        <div className="absolute top-0 -translate-y-52 -left-12 w-64 h-80 bg-background rounded-xl overflow-hidden shadow-lg p-6">
          <div className="flex items-center mb-2">
            <span className="h-2 w-2 bg-primary rounded-full"></span>
            <span className="h-px w-12 bg-primary/30 ml-2"></span>
          </div>
