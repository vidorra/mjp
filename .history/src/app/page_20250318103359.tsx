...
<section className="px-12 py-16 bg-background container mx-auto">
  <div className="flex justify-between items-center mb-8">
    <h3 className="text-2xl font-semibold">Example Outputs</h3>
  ...
  <div className="bg-gray-900 rounded-2xl overflow-hidden">
    ...
    <div className="px-8 py-4 bg-black bg-opacity-70 flex justify-between items-center">
      <div className="text-white text-xl">Summer events</div>
