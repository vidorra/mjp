...
<section className="px-12 py-16 border-t border-gray-100">
  <div className="flex items-center justify-between mb-8">
    <div className="flex items-center space-x-6">
      <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">retool</button>
      <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">remote</button>
      <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">Arc</button>
      <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">Raycast</button>
      <button className="px-4 py-2 rounded-full bg-gray-100 text-sm">runway</button>
    </div>
  </div>
...
<section className="px-12 py-16 bg-white border-t border-gray-100">
  <div className="flex justify-between items-center mb-8">
    <h2 className="text-2xl font-semibold">Example Outputs</h2>
