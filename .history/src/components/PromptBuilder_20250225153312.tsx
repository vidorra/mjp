...
import IntegratedShotType from './IntegratedShotType';
...
export default function PromptBuilder() {
  ...
  const [isIntegratedView, setIsIntegratedView] = useState(false);
    ...
    <div className="space-y-6">
      ...
      <div className="backdrop-blur-lg bg-[#FFF8F5] rounded-[24px] shadow-lg p-6 text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Shot Type Selection Toggle */}
          <div className="col-span-2 flex justify-end mb-4">
            <div className="flex items-center space-x-2">
              <span className="text-sm text-muted-foreground">Shot Type Style:</span>
              <Select
                value={isIntegratedView ? "integrated" : "classic"}
                onValueChange={(value) => setIsIntegratedView(value === "integrated")}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="integrated">Integrated View</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          {isIntegratedView ? (
            <div className="col-span-2">
              <IntegratedShotType
                ...
                onDepthOptionChange={setDepthOption}
              />
            </div>
          ) : (
            <Card>
