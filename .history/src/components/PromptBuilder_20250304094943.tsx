...
const photographyStyles = [
  ...
  { value: 'portrait', label: 'Portrait Photography', suggestedShots: ['medium', 'close-up'] },
...
export default function PromptBuilder() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="backdrop-blur-lg bg-white rounded-[24px] shadow-lg p-6 text-foreground">
                          ...
                          return shot && (
                            ...
                            >
                              <div className="flex items-center gap-2">
                                <i className="far fa-star text-[#FFB768] text-sm" />
                                {shot.label}
                                <span className="text-xs text-[#FFB768] ml-auto">Suggested</span>
                              </div>
                            </SelectItem>
                          );
                        })}
