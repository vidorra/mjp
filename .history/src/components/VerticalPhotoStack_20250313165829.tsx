      ...
      <div className="sticky top-0 w-full h-screen flex items-center justify-center">
        <div className="relative w-full h-full max-w-[85vw] 2xl:max-w-[1600px] mx-auto">
          {photos.map((photo, index) => {
            ...
            if (isSliding || isNext) {
              let fromRotation, fromY, fromX, fromScale;
              let toRotation, toY, toX, toScale;
              ...
              rotation = fromRotation + (toRotation - fromRotation) * slideProgress;
              yPosition = fromY + (toY - fromY) * slideProgress;
              xPosition = fromX + (toX - fromX) * slideProgress;
              scale = fromScale + (toScale - fromScale) * slideProgress;
            }
