...
import { FontAwesomeIcon } from '../../custom_modules/@fortawesome/react-fontawesome';
import {
  faUser,
  faPaw,
  faBox,
  faBuilding,
  faLeaf
} from '../../custom_modules/@fortawesome/pro-solid-svg-icons';
...
import styles from '@/styles/fontawesome.module.scss';
              ...
              <CardContent>
                <div className="grid grid-cols-5 gap-4">
                  {objectCategories.map((cat) => (
                    ...
                    >
                      {cat.category === 'Person' && <FontAwesomeIcon icon={faUser} className="text-2xl" />}
                      {cat.category === 'Animal' && <FontAwesomeIcon icon={faPaw} className="text-2xl" />}
                      {cat.category === 'Product' && <FontAwesomeIcon icon={faBox} className="text-2xl" />}
                      {cat.category === 'Architecture' && <FontAwesomeIcon icon={faBuilding} className="text-2xl" />}
                      {cat.category === 'Nature' && <FontAwesomeIcon icon={faLeaf} className="text-2xl" />}
              ...
              {(['extreme-wide', 'wide', 'full'].includes(shotType)) && (
                <div className="space-y-4 pt-2 border-t">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">Add Depth Description</span>
                    <input
                      type="checkbox"
                      className="h-4 w-4"
                      checked={!!depthOption}
