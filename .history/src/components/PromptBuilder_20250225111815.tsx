                ...
                <div className="grid grid-cols-5 gap-4">
                  {objectCategories.map((cat) => (
                    ...
                    >
                      ...
                      {cat.category === 'Animal' && <i className="far fa-paw text-2xl" />}
                      {cat.category === 'Product' && <i className="far fa-box text-2xl" />}
                      {cat.category === 'Architecture' && <i className="far fa-building text-2xl" />}
                      {cat.category === 'Nature' && <i className="far fa-leaf text-2xl" />}
