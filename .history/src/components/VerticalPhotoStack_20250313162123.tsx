        ...
        <div className="relative w-full h-full max-w-[85vw] 2xl:max-w-[1600px] mx-auto">
          {photos.map((photo, index) => {
            ...
            if (stackPosition === 0) {
              ...
              rotation = -8;
              yPosition = 5; // 5vh down for stacked photos
              xPosition = -14.6;
            }
            
            const slideProgress = scrollY * 6 % 1;
            ...
            if (isSliding) {
              ...
              const nextXPosition = nextPosition === 0 ? -7.3 : -14.6;
              const nextScale = nextPosition === 0 ? 1.15 : 1;
              
              // Smooth out the progress curve
              const acceleratedProgress = Math.min(1, Math.pow(slideProgress * 3, 0.8));
