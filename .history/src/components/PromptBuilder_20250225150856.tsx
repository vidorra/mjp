              ...
              <CardContent>
                <div className="grid grid-cols-5 gap-4">
                  {objectCategories.map((cat) => (
                    ...
                    >
                      {cat.category === 'Person' && <i className={`${styles.fas} fa-user text-2xl`} />}
                      {cat.category === 'Animal' && <i className={`${styles.fas} fa-paw text-2xl`} />}
                      {cat.category === 'Product' && <i className={`${styles.fas} fa-box text-2xl`} />}
                      {cat.category === 'Architecture' && <i className={`${styles.fas} fa-building text-2xl`} />}
                      {cat.category === 'Nature' && <i className={`${styles.fas} fa-leaf text-2xl`} />}
